...
<%
    ...
    if (s_email == null || s_email == "") s_email = "Not Logged";
    ...
    if (c_email == null || c_email == "") c_email = "Not Logged";
%>

    <h1>Join our email list</h1>
    <p> Your email address stored in session: <%= s_email %> <br>
    <p> Your email address stored in cookies: <%= c_email %> <br>
